    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_insert.setOnClickListener{
            ...
            if (ed_book.length() <1 || ed_price.length() <1){
                ...
                try{
                    ...
                    Toast.makeText(this,"新增書名${ed_book.text}  價格${ed_price.text}",Toast.LENGTH_LONG).show()
        ...
        btn_update.setOnClickListener{
            ...
            if (ed_book.length() < 1 || ed_price.length() < 1)
             ...
             Toast.makeText(this,"欄位請勿留白",Toast.LENGTH_LONG).show()

            else

             try {   dbrw.execSQL(" UPDATE myTable SET price = ${ed_price.text}  WHERE book LIKE'${ed_book.text}'")


                 Toast.makeText(this,"更新書名${ed_book.text}  價格${ed_price.text}",Toast.LENGTH_LONG).show()
        ...
        btn_delete.setOnClickListener{
            ...
            if (ed_book.length() < 1)
                ...
                Toast.makeText(this,"書名請勿留白",Toast.LENGTH_LONG).show()
